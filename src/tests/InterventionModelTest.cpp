...
// TODO : look at usage of Location class
// rather than setting attributes in the AttributeTable
...
namespace
{
    ...
    // Implementation: flag = (!flag && day >= trigger_on) || (flag && day >= trigger_off)
    // This means transition flag=flase to flag=true when day crosses trigger_on threshold,
    // and transition from flag=true to flag=false when day crosses trigger_off
