...
def main() :
    ...
    person_df = pd.read_csv(p_filename,  usecols=['pid', 'hid', 'age', 'sex', 'employment_status', 'designation', 'race', 'hispanic'])
    ...
    hra_df =  pd.read_csv(hra_filename, usecols=['hid', 'lid', 'longitude', 'latitude', 'admin1', 'admin2','admin3', 'admin4'])

    gidi_person_df = p_h_df.merge(hra_df, how='left', left_on='hid', right_on='hid')
