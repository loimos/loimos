...
amount of people (233) to generated a poisson distribution of people per location centered 
around lambda = num_people/num_locations. This would transcribe to a 100 location graph,
with a number of people roughly around the given num_people parameter each with about 5 visits per day.
